...
* **[Anon-MultiAsset-TS-RiskAdj-Perf-Pred](https://github.com/xixiangzheng/Anon-MultiAsset-TS-RiskAdj-Perf-Pred)**

  Predicted a weak-signal risk-adjusted target (weighted zero-mean R²) on anonymous multi-asset time-series using a LightGBM/CatBoost/MLP ensemble with ratio features and label-backfill retraining.
